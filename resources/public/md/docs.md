...
Two middleware functions are provided by default in the `zenrepo.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `zenrepo.handler` namespace to manage the enabled middleware.
